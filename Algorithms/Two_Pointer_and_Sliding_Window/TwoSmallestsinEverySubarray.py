...
# Problem Statement
# Given an array of integers arr, the task is to find and return the maximum sum of the smallest and second smallest element among 
# all possible subarrays of size greater than one. If it is not possible, then return -1.
